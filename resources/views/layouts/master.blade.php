...
<div class="col-md-12 brand">
    ...
    <div class="col-md-8">
    	<img src="{{asset('images/final-news-site_06.gif')}}" width="100%" />
    </div>
</div>
...
<div class="col-md-12 bottom">
    	<div class="col-md-4">
            ...
            <img src="{{asset('images/book.png')}}" align="left" /><span class="name"><font color="#e03521">COLOR</font><font color="#fff">MAG</font></span>
        ...
        <div class="col-md-4">
            ...
            Follow us at:<br /><br />
            <a href="https://www.facebook.com/aadirian.sapkota"><img src="{{asset('images/icon-fb.png')}}" /></a>
    		<a href="#"><img src="{{asset('images/icon-twitter.png')}}" /></a>
    		<a href="#"><img src="{{asset('images/icon-google.png')}}" /></a>
    		<a href="#"><img src="{{asset('images/icon-insta.png')}}" /></a>
    		<a href="#"><img src="{{asset('images/icon-pin.png')}}" /></a>
...
<div class="col-md-12 text-center copyright">
	Copyright &copy; 2020  Powered by: <a href="#">Sagarsapkota</a>
</div>
